// Deep-freeze checkpoints for chrome-headcrab: capture the full restorable state of
...
export const CHECKPOINT_DIR =
  process.env.HC_CHECKPOINT_DIR || `${homedir()}/.cache/chrome-headcrab/checkpoints`;
